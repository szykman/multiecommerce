...
.addEventListener('click',function(){
    ...
    const id = selectedMedia.dataset.id;
    const image = selectedMedia.dataset.image;

    switch(currentField){

        case 'logo':

            document.getElementById('logo_media_id').value = id;
        ...
        case 'banner':
            ...
            document.getElementById('banner_media_id').value = id;
        ...
        case 'favicon':
            ...
            document.getElementById('favicon_media_id').value = id;

            if(document.getElementById('favicon_preview')){

                document.getElementById('favicon_preview').innerHTML =
