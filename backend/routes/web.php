...
/*
|--------------------------------------------------------------------------
| WEBHOOKS (fora do grupo tenant — não dependem de domínio específico,
| a loja certa é encontrada via Payment/Order internamente)
|--------------------------------------------------------------------------
*/
...
Route::middleware('tenant')->group(function () {
    ...
    Route::post(
        '/frete/simular',
        [CheckoutController::class, 'simulateShipping']
    )
    ->name('store.shipping.simulate');
    ...
    */
    ...
    Route::middleware('auth:customer')->group(function () {
        ...
        Route::get(
            '/checkout/pagar/{order}/status',
            [CheckoutController::class,'paymentStatus']
        )
        ->name('store.checkout.payment.status');
...
->group(function(){
    ...
    */
    ...
    Route::put(
        'payment-settings/mercadopago',
        [PaymentSettingsController::class, 'updateMercadoPago']
    )
    ->name('payment-settings.mercadopago.update');
